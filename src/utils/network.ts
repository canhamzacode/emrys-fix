...
const NETWORK_CONFIG_MAP: NetworkConfigMap = {
  ...
  [`${BitcoinNetwork.Dogecoin}-${SolanaNetwork.Devnet}`]: {
    binanceUrl: "https://www.binance.com/api",
    aresUrl: process.env.NEXT_PUBLIC_DOGECOIN_DEVNET_ARES_URL ?? "",
    aegleUrl: process.env.NEXT_PUBLIC_DOGECOIN_DEVNET_AEGLE_URL ?? "",
    hermesUrl: process.env.NEXT_PUBLIC_DOGECOIN_DEVNET_HERMES_URL ?? "",
    solanaUrl:
      process.env.NEXT_PUBLIC_SOLANA_DEVNET_RPC ??
      "https://api.devnet.solana.com",
    customSolanaUrl: getLocalStorage(CUSTOM_SOLANA_DEVNET_RPC_KEY) ?? "",
    bitcoinExplorerUrl:
      process.env.NEXT_PUBLIC_DOGECOIN_EXPLORER_URL ??
    ...
    layerCaProgramId: process.env.NEXT_PUBLIC_DEVNET_LAYER_CA_PROGRAM_ID ?? "",
    guardianSetting:
      process.env.NEXT_PUBLIC_DOGECOIN_DEVNET_TWO_WAY_PEG_GUARDIAN_SETTING ?? "",
    assetMint: process.env.NEXT_PUBLIC_DOGECOIN_ASSET_MINT ?? "",
  },
  [`${BitcoinNetwork.Litecoin}-${SolanaNetwork.Devnet}`]: {
    binanceUrl: "https://www.binance.com/api",
    aresUrl: process.env.NEXT_PUBLIC_LITECOIN_DEVNET_ARES_URL ?? "",
    aegleUrl: process.env.NEXT_PUBLIC_LITECOIN_DEVNET_AEGLE_URL ?? "",
    hermesUrl: process.env.NEXT_PUBLIC_LITECOIN_DEVNET_HERMES_URL ?? "",
    solanaUrl:
      process.env.NEXT_PUBLIC_SOLANA_DEVNET_RPC ??
      "https://api.devnet.solana.com",
    customSolanaUrl: getLocalStorage(CUSTOM_SOLANA_DEVNET_RPC_KEY) ?? "",
    bitcoinExplorerUrl:
      process.env.NEXT_PUBLIC_LITECOIN_EXPLORER_URL ??
    ...
    layerCaProgramId: process.env.NEXT_PUBLIC_DEVNET_LAYER_CA_PROGRAM_ID ?? "",
    guardianSetting:
      process.env.NEXT_PUBLIC_LITECOIN_DEVNET_TWO_WAY_PEG_GUARDIAN_SETTING ?? "",
    assetMint: process.env.NEXT_PUBLIC_LITECOIN_ASSET_MINT ?? "",
  },
};
