  ...
  return (
    <Html>
      <Head>
        ...
        <link rel="apple-touch-icon" sizes="180x180" href="/emrys-logo1.png" />
        <link rel="icon" type="image/png" sizes="32x32" href="/emrys-logo1.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="/emrys-logo1.png" />
        <link rel="manifest" href="/site.webmanifest" />
        <link rel="mask-icon" href="/safari-pinned-tab.svg" color={BRAND_COLOR} />
        <link rel="shortcut icon" href="/emrys-logo1.png" />
