    ...
    <button
      ...
      className={classNames(
        'gradient-border body-body1-medium before:gradient-border-b relative flex items-center justify-center gap-x-8 transition duration-200 ease-in-out',
        {
          ...
          // Secondary Styles
          'text-shade-primary before:from-primary-apollo/10 before:via-primary-apollo/5 before:to-primary-apollo/5 bg-white shadow-[inset_0px_-4px_4px_rgba(84,108,241,0.05)] enabled:hover:shadow-[inset_0px_-4px_8px_rgba(84,108,241,0.1),inset_0px_-4px_4px_rgba(84,108,241,0.05)] disabled:opacity-40':
            type === 'secondary',
