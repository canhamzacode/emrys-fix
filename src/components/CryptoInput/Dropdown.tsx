            ...
            >
              <div className={styles.input__group__crypto__dropdown__item__asset}>
                <Image
                  ...
                  height={20}
                />
                <div className={styles.input__group__crypto__dropdown__item__asset__label}>
                  <div className={styles.input__group__crypto__dropdown__item__asset__label__name}>
                    {option.label}
                    <Icon name={option.icon as IconName} size={14} />
                  </div>
                  {option.type && (
                    <span
                      className={styles.input__group__crypto__dropdown__item__asset__label__type}
                    >
                      {option.type}
                    </span>
                  )}
