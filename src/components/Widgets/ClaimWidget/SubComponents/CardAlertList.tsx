      ...
      <div className={cn(styles.claimWidget__card__alert__list, 'pb-[69px]')}>
        <>
          <div className={styles.claimWidget__card__alert__list__ready}>
            <Image src="/graphics/connected.svg" alt="Connected" width={286} height={63} />
            <div className="flex flex-col items-center space-y-4">
              <div className="text-shade-primary flex items-center justify-center space-x-3 text-xl">
                <Image alt="TasksComplete" src="/icons/tasks-complete.svg" width={20} height={20} />
                <span>Connection Complete</span>
              </div>
              <div className="text-shade-mute">
                You are <span className="text-shade-secondary">ready to claim</span> your tBTC below
              </div>
            </div>
          </div>
          <div className={styles.claimWidget__card__alert__list__ready__claimLine}></div>
        </>
      </div>
    );
  } else {
      ...
      <div className={cn(styles.claimWidget__card__alert__list, 'pb-12')}>
        <>
          <div className={styles.claimWidget__card__alert__list__item}>
            <div className={`${styles.claimWidget__card__alert__list__item__number}`}>1</div>
          ...
          <div className={`${styles.claimWidget__card__alert__list__item} !items-start`}>
            <div
            ...
            <div className={styles.claimWidget__card__alert__list__item__title}>
              ...
              <Link
                ...
                target="_blank"
                rel="noreferrer"
                className="text-primary-apollo hover:text-primary-apolloHovered text-base transition"
              >
