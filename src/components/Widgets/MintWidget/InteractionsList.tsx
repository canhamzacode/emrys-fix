          ...
          {interactionsData?.interactions.items.slice(0, 8).map((interaction, index) => (
            ...
            >
              <div className={styles.interactionsList__content__list__item}>
                <div className={styles.interactionsList__content__list__item__number}>
                  #{interactionsData.totalInteractions - index}
                </div>
                <div className={styles.interactionsList__content__list__item__type}>
                  {interaction.interaction_type === InteractionType.Deposit
                    ? 'Deposit'
                    : 'Withdrawal'}
                </div>
                <div className={styles.interactionsList__content__list__item__amount}>
                  <Image
                  ...
                  <span>
                    ...
                    {interaction.interaction_type === InteractionType.Deposit ? 'BTC' : 'zBTC'}
                  </span>
                </div>
              </div>
            </Link>
