      ...
      className={classNames(
        'flex flex-wrap items-center text-white',
        {
          ...
          'w-full flex-nowrap justify-between sm:w-max sm:flex-wrap sm:justify-start':
            type === 'timeline',
          // Segmented Styles
          'rounded-16 border-apollo-border-20 gap-x-8 border p-4': type === 'segmented',
          'border-apollo-border-15 gap-x-4 rounded-full border p-4': type === 'timeline',
          // Underline Styles
          'border-apollo-border-20 px-apollo-10 w-full gap-x-24 border-b': type === 'underline',
        },
        className,
      )}
    >
          ...
          className={classNames(
            ...
            className,
            {
              ...
              'headline-headline6 text-sys-color-text-primary px-8 pb-8 pt-4 disabled:opacity-40':
                type === 'underline',
              'hover:text-sys-color-text-primary': !tab.disabled && type === 'underline',
              '!text-sys-color-text-primary':
                !tab.disabled && activeTab === index && type === 'underline',
            },
          )}
        >
          {tab.icon && <Icon className="relative z-10" name={tab.icon as IconName} />}
