    ...
    >
      <div
        className={classNames('flex items-center justify-center space-x-4', {
          'md:absolute md:left-1/2 md:ml-auto md:-translate-x-1/2': showDropdown,
        })}
      >
        <button
          className={classNames(
      ...
      {showDropdown && (
        <div className={classNames('flex w-max items-center justify-center gap-x-12 md:ml-auto')}>
          <span className="body-body2-medium text-sys-color-text-mute">Items per page</span>
          <Dropdown label={`${itemsPerPage}`} selectedIndex={[10, 25, 50].indexOf(itemsPerPage)}>
